...
public class ParaLearnFOD {
	...
	public static void main(String[] args) {
		...
		ParaLearnFOD mainClass = new ParaLearnFOD();
	...
	public void execLogLike(String[] args) {
		...
		mainClass.readInputs(args);
		mainClass.execProg(args,false);

	}


	public void execProg(String[] args,boolean print){
		...
		for(int i=0;i<totFuncNo;i++){
			...
			for(int p=0;p<totSamples;p++){
				String[] dataVect =  trainData[p];
				int ind =0;
				String indStr ="";
	...
	public void printOutput(String[] args){
		...
		try {
			...
			//writing functions to output file
